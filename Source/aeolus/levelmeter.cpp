...
//}
//
//void LevelMeter::process(const std::vector<float>& buffer)
//{
//    float peak{0.0f};
//    float rms{0.0f};
//
...
//}
//
//void LevelMeter::process(const std::vector<float>& buffer, int channel)
//{
...
//    std::vector<float> ab(layout, 1, size);
