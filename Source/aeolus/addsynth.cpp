...
//std::map<std::string, std::any> N_func::toVar() const
//{
...
//{
//    char buffer[L] = {0};
//    strncpy(buffer, string.toRawUTF8(), std::min(L, (size_t)string.length()));
...
//
//template<size_t L>
//static std::expected readString(std::string& string, std::ifstream stream)
//{
//    char buffer[L] = {0};
